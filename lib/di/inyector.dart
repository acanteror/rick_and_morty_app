...
import 'package:rick_and_morty_app/features/character_detail/infraestructure/repositories/fake_character_detail_repository.dart';
...
void configureInyector() {
  ...
  Get.lazyPut<CharactersRepository>(() => FakeCharactersRepository(), fenix: true);
  ...
  Get.lazyPut<CharacterDetailRepository>(() => FakeCharacterDetailRepository(), fenix: true);
