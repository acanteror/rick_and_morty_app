...
class GraphQLCharacterDetailRepository extends CharacterDetailRepository
  ...
  Future<CharacterDetailViewModel> fetchCharacterDetail(String id) async {
    ...
    if (_response.data != null) {
      final CharacterDetail _characterDetailResponse =
          CharacterDetail.fromMap(_response.data['character']);
