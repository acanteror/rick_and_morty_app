...
void main() {
  ...
  group('characters', () {
    test('should return Data when repository calls dataSource.fetchCharacters', () async {
      when(charactersDataSource.fetchCharacters()).thenAnswer((_) async => tCharactersResponse);
    ...
    test('should throw response exception when api return object with errors', () async {
      when(charactersDataSource.fetchCharacters()).thenAnswer((_) async => tResponseWithErrors);
